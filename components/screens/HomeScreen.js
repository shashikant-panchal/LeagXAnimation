                ...
                >
                    <SafeAreaView style={styles.container}>
                        ...
                        <FlatList
                            ...
                            horizontal
                            inverted
                            contentContainerStyle={{ flex: 1, justifyContent: 'center', padding: SPACING * 2, marginTop: 50, }}
                            scrollEnabled={false}
                            ...
                            renderItem={({ item, index }) => {
                                ...
                                const scale = scrollXAnimated.interpolate({ inputRange, outputRange: [0.8, 1, 0.5], });
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        <Animated.View style={{ position: 'absolute', left: -ITEM_WIDTH / 2, opacity, transform: [{ translateX }, { scale }] }}>
                                            <Image source={{ uri: item.poster }} style={{ width: ITEM_WIDTH, height: ITEM_HEIGHT, borderRadius: 14 }} />
                                        </Animated.View>
                                    </TouchableOpacity>
                                );
                            }}
